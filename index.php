...
<li><a href="topcontributor.php">Top Contributors</a></li>
  ...
  background-color:rgba(0, 0, 0, 0.5);">Cuisine</h2>
    ...
    <div class="category">
        <?php     
        $sql = "SELECT CuisineID, CuisineName, Image FROM Cuisines";
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $imageData = $row['Image']; // Get the image data from the database
        ...
        ?>
                <div style="margin: 0px 10px; border: solid black;">
                    <a href="foodlist.php?cuisine_id=<?php echo $row['CuisineID']; ?>" style="text-decoration: none;">
                        <img src="<?php echo $imageSrc; ?>" alt="<?php echo $row['CuisineName']; ?> photo">
                        <div id="category-text">
                            <h5 class="textcolor"><?php echo $row['CuisineName']; ?></h5>
                        </div>
                    </a>
                </div>
        <?php
